...
- **task1.py**: Python script for predicting protein ORFs from the genome.
- **task2.py**: Python script for digesting protein sequences into peptides using specified enzymes.
- **task3.py**: Python script for calculating mass-to-charge (m/z) ratios for peptides.
- **task4.py**: Python script for calculating ion statistics and generating tabular outputs.
...
- Python 3.x
- Bash shell
- Standard Python libraries (e.g., argparse, re, pandas)
